...
const AudioTrackItem: React.FC<AudioTrackItemProps> = ({ audioFile, audioUrl, timelineVisualDuration, getInteractionHandlers, isSelected, onSelect }) => {
    ...
    // Audio blocks: Do NOT adjust position - startTime is already the timeline position where user placed it
    // This ensures visual position matches playback position
